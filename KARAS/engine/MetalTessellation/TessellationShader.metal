...
* factors [[buffer(1)]]) {
factors[0].edgeTessellationFactor[0] = factor.
x;
factors[0].edgeTessellationFactor[1] = factor.
x;
factors[0].edgeTessellationFactor[2] = factor.
x;
factors[0].
insideTessellationFactor = factor.y;
}
