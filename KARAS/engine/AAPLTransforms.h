...
namespace AAPL
{
    namespace Math
    {
		...
		simd::float3x3 toFloat3x3(simd::float4x4 f44);
		...
		simd::float4x4 rotateX(const float& angle);
		simd::float4x4 rotateY(const float& angle);
		simd::float4x4 rotateZ(const float& angle);
