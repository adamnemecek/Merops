...
final class PositionNode: BaseNode {
    ...
    public required init() {
        ...
        // variable
        let axisLen = SCNFloat(8.0), offset = SCNFloat(axisLen / 2.0), axisSide = SCNFloat(0.05), radius = SCNFloat(axisSide)
        ...
        let XArrow = SCNNode(geometry: xLine), YArrow = SCNNode(geometry: yLine), ZArrow = SCNNode(geometry: zLine)
